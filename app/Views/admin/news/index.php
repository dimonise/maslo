            ...
            <div class="box-body">
                <table class="table table-striped" style="font-size:14px">
                    ...
                    <tr>
						...
						<td><img src="<?php echo $n['img_news']; ?>" style="width: 20%;"></td>
						<td><?php echo $n['data']; ?></td>
						<td><?php echo mb_strimwidth($n['text_news_ua'],0,50,'...', 'UTF-8'); ?></td>
						<td><?php echo mb_strimwidth($n['text_news_ru'],0,50,'...', 'UTF-8'); ?></td>
						<td>
