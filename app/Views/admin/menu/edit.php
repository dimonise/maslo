...
<?php echo form_open('menu/edit/'.$menu[0]['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="name_ru" value="<?php echo (service('request')->getVar('name_ru') ? service('request')->getVar('name_ru') : $menu[0]['name_ru']); ?>" class="form-control" id="name_ru" />
		</div>
	</div>
	<div class="form-group">
		<label for="name_ua" class="col-md-4 control-label">Name Ua</label>
		<div class="col-md-8">
			<input type="text" name="name_ua" value="<?php echo (service('request')->getVar('name_ua') ? service('request')->getVar('name_ua') : $menu[0]['name_ua']); ?>" class="form-control" id="name_ua" />
		</div>
	</div>
