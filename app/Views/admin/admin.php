                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="/assets/#revenue-chart" data-toggle="tab">Area</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/assets/#sales-chart" data-toggle="tab">Donut</a>
                                        </li>
                                    </ul>
                                </div>
                            </div><!-- /.card-header -->
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="pagination pagination-sm">
                                        <li class="page-item"><a href="/assets/#" class="page-link">&laquo;</a></li>
                                        <li class="page-item"><a href="/assets/#" class="page-link">1</a></li>
                                        <li class="page-item"><a href="/assets/#" class="page-link">2</a></li>
                                        <li class="page-item"><a href="/assets/#" class="page-link">3</a></li>
                                        <li class="page-item"><a href="/assets/#" class="page-link">&raquo;</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <div class="card-tools">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu float-right" role="menu">
                                            <a href="/assets/#" class="dropdown-item">Add new event</a>
                                            <a href="/assets/#" class="dropdown-item">Clear events</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="/assets/#" class="dropdown-item">View calendar</a>
                                        </div>
                                    </div>
